                ...
                <BScroll :data="publicList">
                  <ul>
                    <li
                      ...
                      @click="
                    queryPosterGroups(item)
                  "
                      :class="{
                    active: item.appAccountId === curPublic.appAccountId
                  }"
                    >
...
export default {
  ...
  methods: {
    async queryPosterGroups(payload) {
